...
function My_cart() {
  ...
  return (
    <div className={`bg-white ${classes.my_cart}`}>
      ...
      <div className="mt-4 d-flex align-items-center flex-column">
        ...
        <button
          className={`fw-500 fs-16 bgPrimary-1 cBlack-9 my-4 ${classes.productTotal}`}
        >
          Go to Checkout <span className="ps-5 text-white"> >> </span>
        </button>
      </div>
    </div>
  );
